...
var streets = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZXRoYW53ZWRlbWF5ZXIiLCJhIjoiY2t6NG8xZDI4MGliYjMxbzJoZXNtZjd0ZyJ9.sBlw4CXwQ0wHTJbIZXdtbA', {
    maxZoom: 18,
...
var grayscale = L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiZXRoYW53ZWRlbWF5ZXIiLCJhIjoiY2t6NG8xZDI4MGliYjMxbzJoZXNtZjd0ZyJ9.sBlw4CXwQ0wHTJbIZXdtbA', {
    maxZoom: 18,
    attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors, ' +'Imagery © <a href="https://www.mapbox.com/">Mapbox</a>',
    id: 'mapbox/light-v9',
    tileSize: 512,
...
var line = L.polyline(coords, {color: "purple", weight: 5}).bindPopup("Travel Path");
line.addTo(mymap);
...
// Making ISS marker with a custom icon
...
// Change the marker location based on the updated reading
